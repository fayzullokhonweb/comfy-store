...
function Landing() {
  return (
    <div className="bg-white font-[sans-serif] my-4 mb-10">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold mb-20 text-[#333] inline-block relative after:absolute after:w-4/6 after:h-1 after:left-0 after:right-0 after:-bottom-4 after:mx-auto after:bg-pink-400 after:rounded-full">
            Featured Products
          </h2>
        </div>
        <LandingList className="grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6  max-md:max-w-lg mx-auto pb-12" />
      </div>
    </div>
  );
}
